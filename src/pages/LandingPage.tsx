  ...
  return <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
    <header className="border-b border-slate-200 dark:border-slate-800">
      <nav aria-label="Public navigation" className="landing-shell flex h-24 items-center justify-between gap-4">
        <Link data-testid="landing-brand" to="/" className="flex items-center gap-2.5 text-xl font-bold tracking-tight"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-800 text-white"><BookOpen size={20} /></span>RentBook<span className="text-brand-700">.</span></Link>
